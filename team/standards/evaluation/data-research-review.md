...
**Derived from:** `team/knowledge-base/data-research/research.md` ✓ (KB complete — source discovery, DAMA quality dimensions, licence assessment, indicator prioritisation, structural break documentation, output format)
