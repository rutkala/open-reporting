...
The following rules extend `team/standards/evaluation/code-review.md`. They are specific to the data engineering layer and were not covered by the existing standard. Format: `RULE [P1/P2/P3] — [condition] → [why it is a problem]`.
