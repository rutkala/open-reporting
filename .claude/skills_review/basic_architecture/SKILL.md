...
Produced by: `/composite_design` (backend section)
Consumed by: `/composite_build` (`data-engineer` agent)

---

## Location

Embedded in: `products/domain-briefs/{domain}/composite_design.md` (backend section)
Or standalone: `products/domain-briefs/{domain}/basic_architecture.md`
