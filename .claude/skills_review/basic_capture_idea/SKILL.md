...
Save an idea to the Linear ideas board without any formal requirements. Ideas are reviewed later via `/composite_review_ideas` before becoming issues.
...
Do NOT ask follow-up questions. Do NOT start implementing. The idea sits in the backlog until `/composite_review_ideas`.
