...
Called automatically from `/review-ideas` (before converting an idea to a proper issue) and `/sprint` (before moving a Backlog issue to Todo). Can also be invoked directly: `/feasibility OR-XXX`.
