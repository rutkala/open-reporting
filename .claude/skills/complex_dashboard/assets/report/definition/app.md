...
`complex_dashboard.assets.runtime.settings.app_init` — a real Python module inside this skill.
...
- To change the HTML shell or the `teal` template registration, edit `app_init.py` (sibling) — never override in a dashboard
