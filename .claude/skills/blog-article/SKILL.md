...
This skill defines WHAT an article is. The process for producing one lives in `/develop`.
...
| Domain brief | `products/domain-briefs/{domain}/domain-brief.md` | `/research` (via `/document`) |
