...
description: >
  ...
  stop and return to /design before continuing.
  Triggers when: /build or /test reaches the implementation step with a full spec ready.
...
those belong to /design. Implementing under ambiguity creates code that cannot be
