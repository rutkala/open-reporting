---
name: ux-ui-design
description: "UX/UI design artifact. Defines what a frontend design specification is — layout, charts, KPIs, filters, and interactions. Produced by /design and consumed by /build."
...
Produced by: `/design` (dashboard-dev agent)
Consumed by: `/build` (dashboard-dev agent)

---

## Location

Embedded in: `products/domain-briefs/{domain}/design.md` (frontend section)
...
When producing this artifact within `/design`, specify every element below:
