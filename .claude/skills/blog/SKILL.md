...
This skill defines WHAT the blog platform is. For individual article work, use `/blog-article`.
...
1. Article draft produced via `/blog-article`
2. Passes `/evaluate` (content-reviewer)
