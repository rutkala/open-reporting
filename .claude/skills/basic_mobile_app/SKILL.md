...
This skill defines WHAT the mobile product is. The process lives in `/composite_develop`.
For the underlying dashboard components, also load `/complex_dashboard`.
...
|----------|----------|-------------|
| Desktop dashboard | `products/dashboards/{domain}/` | `/complex_dashboard` |
