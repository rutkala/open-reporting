...
4. **Recommendation** — proceed to `/save`, or return to `/collect` for a targeted pass on specific gaps
...
- Minor gaps: flag for the Gaps section in the artifact, proceed to `/save`
- Major gaps (a full section unsupported): return to `/collect` with a targeted scope
