...
description: "Release summary artifact. Defines what a release document is — what was built, where it lives, data sources, known limitations, and date. Produced by /release."
