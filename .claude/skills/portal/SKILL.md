...
This skill defines WHAT the portal is. The process for any portal work lives in `/develop`.
For dashboard-specific work, also load `/dashboard`.
...
|----------|----------|-------------|
| Dashboard product | `products/dashboards/{domain}/` | `/dashboard` + `/build` |
