---
name: cost-estimator
description: "Token budget estimator. Reads a Linear issue and lessons-learned history to forecast token cost range, risk level, and whether the issue should be split. Called during /feasibility and /sprint."
...
| Feature with web research phase | 200–500k tokens | /research or /domain-brief included |
