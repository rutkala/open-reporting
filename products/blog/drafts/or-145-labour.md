---
title: "Bezrobocie w Polsce na historycznym minimum: 3,1% to tylko część obrazu"
slug: "bezrobocie-polska-2024-historyczny-rekord"
excerpt: "Stopa bezrobocia w Polsce wyniosła w 2024 r. 3,1% — najniżej od ponad 30 lat. Co kryje się za tym rekordem i co może go odwrócić?"
tags: ["Rynek pracy", "Polska", "Dane Eurostat", "Bezrobocie"]
linear: OR-145
---
...
Wszystkie wskaźniki rynku pracy prezentowane w tym artykule są dostępne interaktywnie w [portalu Otwarte Raporty](https://portal.open-reporting.dev/labour_market/) — z możliwością eksploracji trendów od 1990 r.
...
- Okres referencyjny: 2024 r. lub ostatnie dostępne dane roczne. Dane Eurostat dostępne na: [ec.europa.eu/eurostat](https://ec.europa.eu/eurostat). Dane GUS dostępne na: [stat.gov.pl](https://stat.gov.pl).

---

<!-- WERYFIKACJA (§4.3 docs/content/principles.md)
- [x] Każda liczba powiązana ze źródłem: tak (Eurostat une_rt_a, lfsa_ergan, lfsa_argan, yth_empl_090, earn_mw_cur; GUS komunikaty o wynagrodzeniach; BGK/GUS dane o imigracji)
- [x] Każde obliczenie zweryfikowane: tak — wzrost płacy minimalnej z 1 750 PLN (2015) do 4 242/4 300 PLN (2024) to wzrost o >142% nominalnie; real wage growth 9,5% vs CPI potwierdzone przez GUS
- [x] Każde porównanie używa porównywalnych definicji: tak — stopy bezrobocia Eurostat LFS/BAEL dla PL i UE-27 używają tej samej definicji ILO; wskaźniki zatrudnienia dotyczą tej samej grupy wiekowej (20-64)
- [x] Polskie konwencje jednostek: tak — przecinek jako separator dziesiętny (3,1%), spacja jako separator tysięcy, pp dla różnic procentowych
- [x] Nagłówek odpowiada danym: tak — 3,1% jest historycznym rekordem Eurostat; nagłówek zawiera pytanie, ale to jest roboczy tytuł przypisany z zewnątrz (spec artykułu). UWAGA: §2.3 zasad zabrania pytań w nagłówkach — do rozważenia zmiana na: "Bezrobocie w Polsce na historycznym minimum: 3,1% to tylko część obrazu"
- [x] Atrybucja źródłowa przy każdym wykresie/twierdzeniu: tak (cytowania inline)
- [x] Brak nieuzasadnionego języka przyczynowego: tak — zmiany opisywane jako "współwystępowanie", "wpływ" podany z ostrożnością; imigracja ukraińska opisana jako "złagodzenie niedoborów", nie "przyczyna niskiego bezrobocia"
- UWAGA: Stopa bezrobocia młodych ok. 10-11% — dane roczne Eurostat (yth_empl_090) wymagają potwierdzenia; przybliżenie na podstawie miesięcznych danych GUS/Eurostat (październik 2024: ~10,8%)
- UWAGA: Minimalna płaca w EUR 2015 (~400 EUR) — szacunek na podstawie kursu PLN/EUR w 2015 r.; kurs był ok. 4,18-4,26 PLN/EUR, co daje ok. 411-419 EUR. Dla ostrożności artykuł podaje "około 400 EUR"
-->
