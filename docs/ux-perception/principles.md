...
*This KB provides the scientific grounding for `docs/visualization/reviewing.md` and `docs/visualization/building.md`. When those standards are updated, trace each rule to the section(s) above that justify it.*
