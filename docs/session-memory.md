...
- `docs/` — 10 KB modules (all complete except public-finance domain ⏳ draft)
- `docs/` — 6 build standards (all with "Derived from" headers)
- `docs/` — 12 eval standards (all wired to agents)
- `docs/playbooks/` — 9 playbooks covering all sub-products
...
- OR-143 Phase 1 cleanup (PR #59 + #60, merged):
  ...
  - Added docs/factory/ DAGs + workstation definitions
  - Added docs/dashboard-assembly.md
