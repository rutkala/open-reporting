...
|---|---|---|--:|---|---|
| ⚫ no open data | Agencja Bezpieczeństwa Wewnętrznego |  |  | ABW intelligence; BIP only | [↗](http://www.abw.gov.pl/pl) |
| 🟢 own WMS/WFS | Agencja Restrukturyzacji I Modernizacji Rolnictwa | arimr_geo | 17 | geoportal.arimr WFS | [↗](http://www.arimr.gov.pl) |
| ⚫ no open data | Agencja Wywiadu |  |  | AW intelligence; BIP only | [↗](http://aw.gov.pl) |
| 🟢 own bulk | Archiwum Akt Nowych |  |  | archival search systems; no open API | [↗](http://www.aan.gov.pl) |
...
| ⚫ no open data | Główny Urząd Miar |  | 109 | GUM no open data found | [↗](http://gum.gov.pl) |
