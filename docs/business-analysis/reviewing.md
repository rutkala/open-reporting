...
**Derived from:** `docs/business-analysis/principles.md` ✓ + `docs/analytical-methods/principles.md` ✓ (SMART+FABRIC indicator design, aggregation correctness, stock/flow, leading/lagging, Polish structural breaks, balanced framing, qualified causal claims)
