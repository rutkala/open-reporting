...
**Derived from:** `docs/data-engineering/principles.md` ✓ + `docs/data-architecture/principles.md` ✓ (dbt staging/mart pattern, incremental models, sources.yml, tests, conformed dimensions, medallion silver→gold)
