...
**Derived from:** `docs/business-analysis/principles.md` ✓ + `docs/analytical-methods/principles.md` ✓ (SMART+FABRIC indicator design, format/scale conventions, Polish unit conventions, percentage vs percentage-point distinction)
