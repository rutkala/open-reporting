...
**Derived from:** `docs/data-engineering/principles.md` ✓ (ELT principle, DuckDB read_csv/TRY_CAST/upsert/fetched_at, Python ETL standards, DAMA quality dimensions)
